...
public class WebAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnWebApplication
    @ConditionalOnClass({SpringHttpSessionConfiguration.class})
    public class HttpSessionConfiguration {

        /**
         * 默认启用SpringSessionMapRepository,适合于spring-session 2.0以下的版本
         *
        ...
        public FactoryBean sessionRegistry() {
            FactoryBean<SessionRepository> objectFactoryBean = new FactoryBean<SessionRepository>(){
                @Override
                ...
                @Override
                public Class<MapSessionRepository> getObjectType() {
        ...
        @Deprecated
        @ConditionalOnWebApplication
        @ConditionalOnClass(name="org.springframework.session.web.http.HttpSessionStrategy")
        ...
        public class HttpSessionStrategyConfiguration {
            @Deprecated
            @Bean
            public HttpSessionStrategy httpSessionStrategy(SpringWebMvcProperties.SessionStrategy config) {
        ...
        @ConditionalOnWebApplication
        @ConditionalOnClass(name="org.springframework.session.web.http.HttpSessionIdResolver")
        @ConditionalOnProperty(name = EnableJerryMice.WEB_SESSION_STRATEGY_ENABLE, havingValue = "true", matchIfMissing = true)
        public class HttpSessionResvolerIdConfiguration{
            @Bean
            public SuperHeaderHttpSessionIdResolver httpSessionIdResolver(SpringWebMvcProperties.SessionStrategy config) {
